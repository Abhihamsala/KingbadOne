...
public static void main(String[] args) throws Exception
	{
		...
		//step1: locate scorecard table in page source and get 1st player runs
		String score=wait.until(ExpectedConditions.visibilityOfElementLocated(
				By.xpath("(//table[contains(@class,'ci-scorecard-table')])[1]/tbody/tr[1]/td[3]/strong"))).getText();
		System.out.println("Score of First player : "+score );
	}
}		
