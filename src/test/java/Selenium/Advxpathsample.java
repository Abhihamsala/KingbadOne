...
public class Advxpathsample {
	...
	public static void main(String[] args) throws Exception
	{
		...
		//Testcase3 : get no out batsman name in 1 st scorecard
		String z=wait.until(ExpectedConditions.visibilityOfElementLocated(
																		 By.xpath("(//table[contains(@class,'scorecard-table')])[1]/tbody//td[contains(text(),'not out ')]/preceding-sibling::td"))).getText();
