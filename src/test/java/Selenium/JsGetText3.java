...
public class JsGetText3 {
	...
	public static void main(String[] args) throws Exception
	{
		...
		WebElement e= Abhi.findElement(By.xpath("(//span[@rel='current_population'])"));
		System.out.println("*****************************************************************************************************************");
		...
		String y=(String) js.executeScript("return(arguments[0].childNodes[7].textContent);",e);
		System.out.println(y);	
		System.out.println("*****************************************************************************************************************");
		//3. Get all dynamic child elements text one after other using javascripts
		for(int i=0;i<8;i++)
		{
		String z=(String) js.executeScript("return(arguments[0].childNodes["+i+"].textContent);",e);
