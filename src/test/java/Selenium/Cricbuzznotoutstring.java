...
public class Cricbuzznotoutstring {
	...
	
	{
		...
		//String tempone=Abhi.findElement(By.xpath("(//div[contains(@class,'cb-col cb-col-33')]/following-sibling::div[contains(@class,'text-right text-bold') and text()!='R'])["+pos+"]")).getText();
         ...
         String CName=Abhi.findElement(By.xpath("//div[@id='innings_"+INN+"'and @class='ng-scope']//*[text()='not out']/preceding::div[1]")).getText();
	     String Crun=Abhi.findElement(By.xpath("//div[@id='innings_"+INN+"'and @class='ng-scope']//*[text()='not out']/following::div[1]")).getText();
	       	 
		 System.out.println("Name : "+CName+" Runs : "+Crun);
	
		 System.out.println("******************************************************************");	
		 // System.out.println("Name : "+nobn+" Runs : "+nob);	
		 //div[@id='innings_1'and @class='ng-scope']//span[text()='not out']/preceding::div[1]
		 // Abhi.close();
