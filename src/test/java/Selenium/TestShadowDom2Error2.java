...
public class TestShadowDom2Error2 {
	...
	//	System.setProperty("webdriver.chrome.logfile","target\\TestlogJan5.txt");
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(
				       By.xpath("//book-app[@apptitle='BOOKS']")))  // goto shadow host
		              .getShadowRoot() //go to shadow root
		              .findElement(By.id("input"))//go to target element
		              .sendKeys("abdul kalam");//operate
