...
public class Advxpathherierchy2 {
...
//heirachly xpath
	...
	public static void main(String[] args) throws Exception
	{
		...
		//Step1: locate all scorecard table in page source
		...
		//Step2 : locate all players rows in scorecard table in page source
		   ...
		   for (WebElement batsman:batsmen)
			{
					//get all details
			   List<WebElement> details=batsman.findElements(By.xpath("child::td"));
