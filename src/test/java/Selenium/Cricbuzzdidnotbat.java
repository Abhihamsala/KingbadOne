...
public class Cricbuzzdidnotbat {
	...
	
	{
		...
		//String tempone=Abhi.findElement(By.xpath("(//div[contains(@class,'cb-col cb-col-33')]/following-sibling::div[contains(@class,'text-right text-bold') and text()!='R'])["+pos+"]")).getText();
		 ...
		 //who didn't bat.
		 List<WebElement>dnbt=Abhi.findElements(By.xpath("//div[@id='innings_"+INN+"'and @class='ng-scope']//*[contains(text(),'Did not Bat')]/following-sibling::div/a"));
		 
		 for(WebElement bat:dnbt)
		 {
